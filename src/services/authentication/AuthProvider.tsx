...
import { Location } from 'oidc-react';
import { AuthContext, AuthProviderProps, Error } from './types';
...
export const AuthProvider: FC<AuthProviderProps> = ({
  ...
  useEffect(() => {
    ...
    getUser();
  }, [location, autoSignIn, onBeforeSignIn, onSignIn, onSignInError, userManager]);
  ...
  useEffect(() => {
    ...
    userManager.events.addAccessTokenExpired(signinSilent);

    return () => {
      userManager.events.removeAccessTokenExpired(signinSilent);
    };
  }, [userManager]);
