...
import { useLeasingProgramsQuery } from './useLeasingProgramsQuery';
...
const SearchableSelect = (props: any) => {
  ...
  const { programs } = useLeasingProgramsQuery('', []);
...
export const LeasingProgramSelectField = ({ input, meta, ...rest }: Props) => (
  <SearchableSelect
    {...input}
    {...rest}
